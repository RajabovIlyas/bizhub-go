...
// TODO: her bir map ucin ayratyn mutex gerek!!! bolmasa ahli isler bir birine garasmaly bolyar!
...
func (s *OjoCronService) RemoveJobsByGroup(group interface{}) error {
	_, err := s.coll.DeleteMany(context.Background(), bson.M{
		"group": group,
	})
